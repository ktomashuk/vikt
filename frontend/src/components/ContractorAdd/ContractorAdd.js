      ...
      <Dialog open={open} onClose={handleClose} TransitionComponent={Transition} fullWidth maxWidth="sm" >
        <AppBar className={classes.appBar}>
          <Toolbar>
            ...
            <TextField style={{width: '50%'}} label="Название контрагента" placeholder="Введите название контрагента"
...
export default connect(mapStateToProps, { addContractor, getContractors })(EstimateModal);