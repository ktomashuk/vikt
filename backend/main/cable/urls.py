...
urlpatterns = [
    ...
    path('cable-delete/', cable_views.CableJournalDeleteView.as_view(), name='cable-delete'),
    path('export/<int:id>/<str:system>/', cable_views.ExportView.as_view(), name='export'),
]