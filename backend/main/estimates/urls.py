...
urlpatterns = [
    ...
    path('nonest-obj-sys/<int:id>/<str:system>/',
         estimate_views.NonEstimatesByObjectBySystemView.as_view(), name='nonest-obj-sys'),
    path('nonest-obj/<int:id>/',
         estimate_views.NonEstimatesByObjectView.as_view(), name='nonest-obj'),
    path('nonest-update/<int:id>/',
         estimate_views.NonEstimateUpdateView.as_view(), name='nonest-update'),
    path('search-nonest-obj/<int:id>/',
         estimate_views.SearchNonEstimatesByObjectView.as_view(), name='search-nonest-obj'),
    path('search-nonest-obj-sys/<int:id>/<str:system>',
         estimate_views.SearchNonEstimatesByObjectBySystemView.as_view(), name='search-nonest-obj-sys'),
    path('test/',
